...
Circle.prototype =
{
	...
	{
		ctx.strokeStyle = style || "#000";
		ctx.beginPath();
		ctx.arc( this.x, this.y, this.r * this.scale, 0, Math.PI * 2 );
		ctx.stroke();
	},

	lerp : function( t, origin, destination )
	{
	...
	minimumEnclosingCircle : function( points )
	{
	...
	isInCircle : function(c, x, y)
	{
		return c != null && this.distance(x, y, c.x, c.y) < c.r + 1e-12;
	},
